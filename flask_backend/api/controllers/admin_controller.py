...
def update_user(user_id):
    ...
    print(f"DEBUG: Received student_id: {student_id} (type: {type(student_id)})")
    print(f"DEBUG: Current student_id: {user.student_id}")
    ...
    if student_id is not None:
        ...
        if student_id == "":
            ...
            print(f"DEBUG: Clearing student_id")
        else:
            ...
            print(f"DEBUG: Setting student_id to {student_id}")
    ...
    # Save changes
    try:
        print(f"DEBUG: Before update - student_id: {user.student_id}")
        user.update()
        print(f"DEBUG: After update - student_id: {user.student_id}")
